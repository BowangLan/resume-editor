...
export const ResumeView = memo(function ResumeView() {
  ...
  return (
    <div className="mx-auto max-w-[8.5in] space-y-3">
      <Alert className="bg-card/80 backdrop-blur supports-backdrop-filter:bg-card/70">
        <Info />
        <AlertTitle>Preview is approximate</AlertTitle>
        <AlertDescription>
          <p>
            The exported PDF generated from LaTeX will be the real output (and
            typically looks more professional than this HTML preview). To
            generate a PDF from the LaTeX code, paste it into{" "}
            <a
      ...
      <div className="flex items-center gap-2">
        ...
        <RichButton
          ...
          variant="outline"
          size="icon-sm"
          tooltip="Copy LaTeX code to clipboard"
        >
      ...
      <Card className="min-h-[11in] p-10 bg-white dark:bg-gray-950 shadow-lg font-latin-modern-roman">
